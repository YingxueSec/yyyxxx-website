...
actions:
  ...
  - text: 查看官网联系页
    href: /#contact
    variant: outline
ctaTitle: 加入映雪AI QQ 群，获取开通咨询
ctaDescription: QQ 群号 897500387，支持套餐咨询、使用说明、开通答疑与活动通知
ctaHref: https://qm.qq.com/q/HASkWRLpw6
ctaLabel: 立即加入 QQ 群
---
...
<div class="rounded-2xl border border-primary/20 bg-gradient-to-r from-primary/10 via-pink-500/10 to-indigo-500/10 p-6">
  <h3 class="mt-0">加入映雪AI QQ 群</h3>
  <p>群号：<strong>897500387</strong></p>
  <p>可咨询套餐选择、开通流程、使用说明、活动信息，也方便后续获取更新通知。</p>
  <p class="mb-0">
    <a href="https://qm.qq.com/q/HASkWRLpw6" target="_blank" rel="noopener noreferrer">点击加入 QQ 群</a>
  </p>
</div>
